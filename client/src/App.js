...
/* ===== SOCKET SERVER URL ===== */
/* Works both locally and after deployment on Render */
const SERVER_URL =
          ...
          <div style={{ width: "80%", display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <button onClick={runCode} style={iconBtn}>
                  ▶
                </button>

                <button onClick={downloadCode} style={iconBtn}>
                  ⬇
                </button>

                <button onClick={copyRoomLink} style={iconBtn}>
                  🔗
                </button>
              </div>
            </div>
